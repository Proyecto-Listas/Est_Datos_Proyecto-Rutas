...
class LCSE:
    ...
    def insertionSort(self,criterio):
        ...
        if (criterio=="peso" or criterio == "id" or criterio == "cantidad_paquetes" or criterio =="valor_mercancia"):
            ...
            #al mover un nodo de una posicion para no romper la lista circular necesitamos que el anterior a ese nodo apunte a el siguiente de ese nodo, asi cuando "quitemos" un nodo de una posicion la lista no se rompa, por eso nesecitamos esta variable
...
class Tree():
    ...
    def limpiarArbol(self):
        self.raiz.hijos_Xpos_YPos.cabeza=None
        self.raiz.hijos_Xpos_YNeg.cabeza=None
        self.raiz.hijos_XNeg_YPos.cabeza=None
        self.raiz.hijos_XNeg_YNeg.cabeza=None
...
class Tree2():
    ...
    def limpiarArbol(self):
        for i in range(0,len(self.raiz.hijos2)):
            self.raiz.hijos2[i].cabeza=None
...
def MostrarMenu(arbolx):
    ...
    while True:
        ...
        if op==1:
            ...
            print("\n--------------------------- Buscar en el arbol -----------------------------\n")
            eleccion = input("\nA continuacion, ingrese:\n\n 1. Para buscar por peso.\n 2. Para buscar por coordenadas.\n 3. Para buscar por nombre.\n\nSu opcion es: ")
            if eleccion == "1":
                peso = float(input("Ingrese el peso a buscar: "))
                encontrado=arbolx.buscar("peso",peso)
                if encontrado[0]<1:
                    print("Elemento no encontrado")
                else:
                    print(f"Elememto encontrado en la ruta {arbolx.rutas[encontrado[0]]} posicion {encontrado[1]}")
            elif eleccion == "2":
                coordx = float(input("Ingrese las coordenadas x a buscar: "))
                coordy = float(input("Ingrese las coordenadas y a buscar: "))
                encontrado=arbolx.buscar("coordenadas",coordx,coordy)
                if encontrado[0]<1:
                    print("elemento no encontrado")
                else:
                    print(f"elememto encontrado en la ruta {arbolx.rutas[encontrado[0]]} posicion {encontrado[1]}")
                ...
                encontrado=arbolx.buscar("nombre",nombre)
                if encontrado[0]<1:
                    print("elemento no encontrado")
                else:
                    print(f"elememto encontrado en la ruta {arbolx.rutas[encontrado[0]]} posicion {encontrado[1]}")
            ...
            if arbolx.raiz.hijos2[0].toString() == "-1" and arbolx.raiz.hijos2[1].toString() == "-1" and arbolx.raiz.hijos2[2].toString() == "-1" and arbolx.raiz.hijos2[3].toString() == "-1":
                print("Arbol vacio")
            else:
